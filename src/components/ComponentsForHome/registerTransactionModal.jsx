...
const RegisterTransactionModal = memo(({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="space-y-6 md:space-y-10 pb-4" role="main">
          <DialogHeader>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6" noValidate>
              ...
              <div className="flex pt-4 flex-col sm:flex-row gap-3 sm:gap-0 sm:justify-between" role="group" aria-label="Ações do formulário">
                <ButtonC
                  texto="Cancelar"
                  largura="100%"
                  altura="40px"
